...
addGame(
  27,
  "Ninja 3",
  "Ninja Hattori-kun - Ninja wa Syugyou de Gozaru (Japan).nes"
);
...
addGame(
  97,
  "Higemaru",
  "Higemaru - Makai-jima - Nanatsu no Shima Daibouken (Japan).nes"
);
addGame(98, "Ikari", "Ikari Warriors (USA).nes");
addGame(
  99,
  "A Close All",
  "Magnum Kikiippatsu - Empire City - 1931 (Japan).nes"
);
...
const mario = {
  ...
  file: `/emulatorJs/roms/NES/Super Mario Bros. (World).nes`,
  oldCores: true,
};
...
games = [];
addGame(1, "Resident Evil 3", "resident evil 3.bin", true, "PSX");

const psx = games;

export { games64, games94, games101, mario, snes, psx };
